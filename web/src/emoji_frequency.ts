...
function preferred_emoji_list(): Emoji[] {
...
function initialize_data(info: {messages: Message[]; popular_emojis: Emoji[]}): void {
...
function update_data_for_message_id(info: {
    message_id: number;
    emoji_id: string;
    emoji_code: string;
    emoji_type: string;
...
function remove_reaction_from_data(info: {
    emoji_id: string;
    message_id: number;
    is_me: boolean;
}): void {
